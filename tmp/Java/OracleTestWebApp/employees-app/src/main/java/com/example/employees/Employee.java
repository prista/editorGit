...
public class Employee {
	...
	/**
	 *
	 * The reason for two constructors is that the second one creates a new Id for the employee.
	 * This constructor will used when we want to create a new Employee.
	 */
